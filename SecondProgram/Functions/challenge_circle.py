...
# Challenge:
# Modify the circle function so tha tit allows the colour of the circle to be specified
# aand defaults to red if a colour is not given.
...
def circle(page, radius, g, h, colour="red"):
   page.create_oval(g + radius, h + radius, g - radius,
                    h - radius, outline=colour, width=2)
